...
function toggleCorrespondenceAddress() {
    ...
    var correspondenceAddressWrapper = document.getElementById("adres-korespondencyjny-wrapper");
    var correspondenceAddressInput = document.getElementById("adres-korespondencyjny");
  
    if (checkbox.checked) {
      correspondenceAddressWrapper.style.display = "none";
      correspondenceAddressInput.disabled = true;
      correspondenceAddressInput.value = ""; // Resetuj wartość pola
    } else {
      correspondenceAddressWrapper.style.display = "block";
      correspondenceAddressInput.disabled = false;
    }
  }
  //Zad1
//   function enableProvinceField() {
//     var countrySelect = document.getElementsByName("country")[0];
//     var provinceSelect = document.getElementById("wojewodztwo");
//     var addressInput = document.getElementById("adres-zamieszkania");
//     var correspondenceAddressInput = document.getElementById("adres-korespondencyjny");
...
//       provinceSelect.selectedIndex = 0; // Resetuj wybór województwa
//       addressInput.disabled = true;
//       correspondenceAddressInput.disabled = true;
//       addressInput.value = ""; // Resetuj wartość pola
//       correspondenceAddressInput.value = ""; // Resetuj wartość pola
//     }
//   }
  //Zad2
  function toggleProvinceField() {
    var countrySelect = document.getElementsByName("country")[0];
    var provinceSelect = document.getElementById("wojewodztwo");
    var provinceTextInput = document.getElementById("wojewodztwo-text");
  
    if (countrySelect.value === "Polska") {
      provinceSelect.style.display = "inline-block";
      provinceTextInput.style.display = "none";
      provinceSelect.disabled = false;
      provinceTextInput.disabled = true;
    } else {
      provinceSelect.style.display = "none";
      provinceTextInput.style.display = "inline-block";
      provinceSelect.disabled = true;
      provinceTextInput.disabled = false;
    }
  }
//Zad3
function telefonik(input) {
    input.value = input.value.replace(/\D/g, ""); // Usuń wszystko oprócz cyfr
  }
